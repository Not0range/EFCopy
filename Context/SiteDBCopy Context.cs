...
{
	public class КопияКонтекстСайтаБД : DbContext
	{
		public КопияКонтекстСайтаБД(DbContextOptions<КопияКонтекстСайтаБД> options) : base(options)
		{
		}

		protected override void OnConfiguring(DbContextOptionsBuilder options)
            => options.UseSqlServer(@"Server=127.0.0.1;Port=5432;" +
            "Database=Blogs;User Id=postgres;Password=123456;");
